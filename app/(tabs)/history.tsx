...
export default function HistoryScreen() {
    ...
    const stats = useMemo(() => {
        ...
        const completion = total > 0 ? (taken / total) * 100 : 0;
    ...
    const renderLog = ({ item }: { item: Medication }) => {
        ...
        return (
            <View style={[styles.logCard, isDone && styles.logCardDone]}>
                ...
                {isDone ? (
                    <Text style={[styles.statusText, { color: status === 'taken' ? '#059669' : '#DC2626' }]}>
        ...
        <View style={styles.container}>
            <View style={styles.header}>
                <View>
                    ...
                    <Text style={styles.subtitle}>Track your medication activity</Text>
                </View>
                <View style={styles.headerButtons}>
                    <TouchableOpacity style={styles.headerButton} onPress={handleWeeklyReport}>
                        <Ionicons name="document-text-outline" size={22} color="#4F46E5" />
                        <Text style={styles.headerButtonText}>Weekly</Text>
                    </TouchableOpacity>
